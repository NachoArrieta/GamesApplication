...
import com.nacho.gamesapplication.presentation.gameScreen.components.GameImage
...
import com.nacho.gamesapplication.utils.shareMessage
                            ...
                            Button(
                                onClick = {
                                    ContextCompat.startActivity(
                                        context,
                                        Intent(Intent.ACTION_VIEW, Uri.parse(it.gameUrl)),
                                        null,
                                    )
                                },
                            ) {
